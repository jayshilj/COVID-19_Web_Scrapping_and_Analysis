...
Images - Stores the images generated in the project
Analysis_for_COVID_19.html - HTML page to show all the dynamic visualizations generated by plotly
Analysis_for_COVID_19.ipnb - The code for all the visualizations and dstack integration (Worldwide)
COVID-19 World Data Web Scrapping.ipynb - The code for all the Web Scrapping and RDBMS integration of all the world countries
COVID19_USASTATES_WebScraping.ipynb - The code for all the Web Scrapping and RDBMS integration of all the US States
